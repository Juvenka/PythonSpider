...
i = 0
if not os.path.exists('C:\\Users\\Administrator\\Desktop\\erotic_pics'):
    os.mkdir('C:\\Users\\Administrator\\Desktop\\erotic_pics')
for tar in tar_tag:
    i += 1
    if i <= 6:
        continue
    else:
        f = open('C:\\Users\\Administrator\\Desktop\\erotic_pics' + os.sep + tar.string + '.txt', 'w')
